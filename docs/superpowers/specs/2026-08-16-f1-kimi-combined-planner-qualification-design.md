...
```text
F1_KIMI_PLANNER_QUALIFICATION_DESIGN=RECONCILED_SPECIFICATION_REVIEWED
DESIGN_WORK_AUTHORIZED=YES
WRITTEN_SPEC_APPROVED=YES
FINAL_INDEPENDENT_REVIEW=APPROVED
FINAL_INDEPENDENT_REVIEW_CRITICAL=0
FINAL_INDEPENDENT_REVIEW_IMPORTANT=0
FINAL_INDEPENDENT_REVIEW_MINOR=0
